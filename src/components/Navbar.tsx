        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-2 relative z-50 md:ml-6">
              ...
              <span className="text-xl font-bold text-foreground animate-pulse bg-gradient-to-r from-primary via-blue-500 to-purple-500 bg-clip-text text-transparent animate-[glow_2s_ease-in-out_infinite_alternate] drop-shadow-[0_0_10px_theme(colors.primary)]">MyanShops</span>
            </Link>
          </div>
